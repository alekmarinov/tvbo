...
public class HorizListView2 extends AdapterView<BaseAdapter>
{
	private static final String TAG = HorizListView2.class.getSimpleName();
	...
	public HorizListView2(Context context)
	{
		super(context);
		init(context, context.obtainStyledAttributes(R.styleable.HorizListView2));
	}

	public HorizListView2(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		init(context, context.obtainStyledAttributes(attrs, R.styleable.HorizListView2));
	}

	public HorizListView2(Context context, AttributeSet attrs, int defStyle)
	{
		super(context, attrs, defStyle);
		init(context, context.obtainStyledAttributes(attrs, R.styleable.HorizListView2, defStyle, 0));
	}
	...
	private void notifyOnItemSelecting(int newPosition)
	{
		...
		_onItemSelectingListener.onItemSelecting(HorizListView2.this, _selectedChild, _position, newPosition);
	}
	...
	private void notifyOnItemSelected()
	{
		...
		_onItemSelectedListener.onItemSelected(HorizListView2.this, _selectedChild, _position,
	...
	private void notifyOnItemUnselected(int position)
	{
		...
		_onItemUnsetSelectionListener.onItemUnsetSelection(HorizListView2.this, _selectedChild, position);
	}
